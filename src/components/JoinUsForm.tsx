...
const positions = ["Frontend Developer", "Backend Developer", "UI/UX Designer", "Project Manager", "Other"] as const;
                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    <div className="flex flex-col">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex-1">
                                        <FormLabel
                                            className="font-helvetica-light text-lg uppercase">
                                            First Name
                                        </FormLabel>
                                        <FormControl>
                                            <input
                        ...
                        <div className="Submit">
                            <Button
                                className="py-5.5 px-28 rounded-none uppercase text-base sm:text-md md:text-lg font-helvetica-light cursor-pointer hover:bg-transparent hover:text-black hover:border hover:border-black"
                            >
                                Submit
                            </Button>
                        </div>
